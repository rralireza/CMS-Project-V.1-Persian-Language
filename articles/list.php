                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                        ...
                        <tr>
                            ...
                            foreach ($roze as $rose):
                            ?>
                            <td><img src="<?php echo $row->image; ?>" width="100px" height="50px"></td>
                            <td><a href="dashboard.php?m=articles&p=edit&id=<?php echo $row->id; ?>&pic=<?php echo $rose->id ?>" class="btn btn-warning btn-xs"><i class="mdi mdi-pencil-outline"></i></a></td>
                            <td><a href="dashboard.php?m=articles&p=delete&id=<?php echo $row->id; ?>&pic=<?php echo $rose->id ?>" class="btn btn-danger btn-xs"><i class="mdi mdi-delete"></i></a></td>
                        </tr>
                        <?php
                            endforeach;
                        ?>
