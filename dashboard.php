...
if (!isset($_SESSION['name'])) {
    header('location: pages-login.php?error3');
}
?>
...
<head>
        ...
        <title>وب سایت خبری تحلیلی</title>
...
<!--        </div>-->
        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                ...
                <div class="left-side-logo d-block d-lg-none">
                    <div class="text-center">
                        ...
                        ?>
                        <a href="dashboard.php?m=index&p=index&pic=<?php echo $row->id ?>" class="logo"><img src="assets/images/logo_dark.png" height="20" alt="logo"></a>
                    </div>
                </div>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            <li class="menu-title">منوهای سایت</li>

                            <li>
                                <a href="dashboard.php?m=index&p=index&pic=<?php echo $row->id ?>" class="waves-effect">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="dripicons-briefcase"></i> <span> نوشته‌ها </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="dashboard.php?m=articles&p=add&pic=<?php echo $row->id ?>">نوشته‌ی جدید</a></li>
                                    <li><a href="dashboard.php?m=articles&p=list&pic=<?php echo $row->id ?>">مدیریت نوشته‌ها</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="dashboard.php?m=categories&p=add&pic=<?php echo $row->id ?>">افزودن دسته بندی جدید</a></li>
                                    <li><a href="dashboard.php?m=categories&p=list&pic=<?php echo $row->id ?>">مدیریت دسته بندی‌ها</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="logout.php" class="waves-effect">
                                    ...
                                    <span> خروج <span class="badge badge-success badge-pill float-right"></span></span>
                                </a>
                            </li>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-left	d-none d-lg-block">
                            <div class="text-center">
                                <a href="dashboard.php?m=index&index&pic=<?php echo $row->id ?>" class="logo"><img src="assets/images/logo.png" height="22" alt="logo"></a>
                            </div>
                        </div>
                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list nav-user">
                                    ...
                                    aria-haspopup="false" aria-expanded="false">
                                        ...
                                        <img src="<?php echo $row->image; ?>" alt="تصویر کاربر" class="rounded-circle">
                                        <?php
                                            endforeach;
                                        ?>
                ...
                <footer class="footer">
                    <button type="button" class="btn btn-primary waves-effect mo-mb-2"
                            data-container="body" data-toggle="popover" data-placement="bottom"
                            data-content="Developed by THE_ARN">
                        Say My Name
                    </button>
                    <br>
