...
$id = $_GET['id'];
$items = showCatData($id);
if (isset($_POST['btn'])) {
    $data = $_POST['frm'];
    $connect = config();
    $result = $connect->prepare("UPDATE categories SET title = ? , status = ? , chid = ? WHERE id = '$id'");
    $result->bindParam(1 , $data['title']);
    $result->bindParam(2 , $data['status']);
    $result->bindParam(3 , $data['chid']);
    $result->execute();
}
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title m-0">ویرایش دسته بندی‌های ایجاد شده</h4>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="frm[title]" type="text" placeholder="لطفا عنوان دسته بندی موردنظر خودتان را وارد کنید" id="example-text-input" value="<?php echo $rows->title ?>">
                        </div>
                    </div>
